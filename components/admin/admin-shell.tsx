...
const navItems: NavItem[] = [
  ...
  { title: "Product Upload", href: "/admin/dashboard/product-upload", icon: Upload },
  { title: "Transactions", href: "/admin/dashboard/transactions", icon: CreditCard },
  { title: "Revenue", href: "/admin/dashboard/revenue", icon: TrendingUp },
  { title: "All Orders", href: "/admin/dashboard/all-orders", icon: ListOrdered },
  { title: "Track Orders", href: "/admin/dashboard/track-orders", icon: Truck },
  { title: "Site Manager", href: "/admin/dashboard/site-manager", icon: Wrench },
